...
#
#   0.     PEP-8 compliance (David Brown <dbrown@bnl.gov>, 2021-09-10T21:20:06)
#   1.     no xmlrunner for now (David Brown <dbrown@bnl.gov>, 2018-12-04T22:06:10)
#   2.     from __future__ imports missing (David Brown <dbrown@bnl.gov>, 2018-12-04T18:36:38)
#   3.     Python3.X compatibility & PEP-8 compliance (David Brown <dbrown@bnl.gov>, 2018-12-04T15:18:59)
#   4.     tweak paths again (David Brown <dbrown@bnl.gov>, 2014-09-15T14:25:41)
#   5.     tweak test data paths (David Brown <dbrown@bnl.gov>, 2014-09-15T14:19:36)
#   6.     fix whitespace in a few unit tests & fix call to retrieve (David Brown <dbrown@bnl.gov>, 2014-02-13T15:57:05)
#   7.     clean up the unit tests now that there is a mini database to work with (David Brown <dbrown@bnl.gov>, 2014-02-13T14:33:45)
#   8.     small database for unit testing (David Brown <dbrown@bnl.gov>, 2014-02-04T17:31:06)
#   9.     fix wiring if rawEntry=False (which is now the default) & update unit tests (David Brown <dbrown@bnl.gov>, 2013-06-19T12:18:10)
#   10.     fix last test (David Brown <dbrown@bnl.gov>, 2013-01-09T15:25:10)
#   11.     upgrade test to go with upgraded database (David Brown <dbrown@bnl.gov>, 2013-01-09T15:22:18)
#   12.     fix broken unit tests (David Brown <dbrown@bnl.gov>, 2012-01-25T19:38:19)
#   13.     tweaks for last set of tests (David Brown <dbrown@bnl.gov>, 2012-01-23T19:35:52)
#   14.     try to get this test working with automated system (David Brown <dbrown@bnl.gov>, 2012-01-23T19:20:17)
#
################################################################################
...
class TestX4DBManager(unittest.TestCase):
    ...
    def test_fixkey(self):
        self.assertEqual(exfor_manager.__fixkey__(10001), '10001')
        self.assertEqual(exfor_manager.__fixkey__(10001015), '10001015')
        self.assertEqual(exfor_manager.__fixkey__('10001'), '10001')
        self.assertEqual(exfor_manager.__fixkey__('10001015'), '10001015')
        self.assertRaises(KeyError, exfor_manager.__fixkey__, '1000101')

    def test_entry_query(self):
        self.assertEqual(self.dbMgr.query(ENTRY=10001), {
            '10001': ['10001001', '10001002', '10001003', '10001004', '10001005', '10001006', '10001007', '10001008',
                      '10001009', '10001010', '10001011', '10001012', '10001013', '10001014', '10001015', '10001016',
                      '10001017']})
    ...
    def test_author_query(self):
        self.assertEqual(self.dbMgr.query(author="Panitkin"),
                         {'40121': ['40121001', '40121002'], '40177': ['40177001', '40177002', '40177003'],
                          '40431': ['40431001', '40431002'], '41335': ['41335001', '41335002']})
    ...
    def test_getitem_subent(self):
        self.assertEqual(str(self.dbMgr['E0783002']), str(self.dbMgr.retrieve(
            SUBENT='E0783002')))  # , { 'E0783':[ NEWENTRYANSWER[ 'E0783' ][0], NEWENTRYANSWER[ 'E0783' ][1] ] } )
    ...
    def test_targ_reaction_da_quant_query(self):
        self.assertEqual(self.dbMgr.query(target='H-1', reaction='N,EL', quantity='DA'), {
            ...
            u'20964': [u'20964001', u'20964002', u'20964003', u'20964004', u'20964005', u'20964006', u'20964007',
                       u'20964008', u'20964009', u'20964010', u'20964011', u'20964012', u'20964013', u'20964014',
                       u'20964015', u'20964016', u'20964017', u'20964018', u'20964019', u'20964020', u'20964021',
                       u'20964022', u'20964023', u'20964024', u'20964025', u'20964026', u'20964027', u'20964028'],
    ...
    def test_targ_reaction_pol_quant_query(self):
        ...
        self.assertEqual(self.dbMgr.query(target='H-1', reaction='D,EL', quantity='POL/DA'), {
            ...
            u'E0811': [u'E0811001', u'E0811004', u'E0811005', u'E0811006', u'E0811007', u'E0811008', u'E0811009',
                       u'E0811010'],
            ...
            u'E1772': [u'E1772001', u'E1772005', u'E1772006', u'E1772007', u'E1772008', u'E1772009', u'E1772010',
                       u'E1772011', u'E1772012', u'E1772013', u'E1772014', u'E1772015', u'E1772016', u'E1772017',
                       u'E1772018', u'E1772019', u'E1772020', u'E1772021', u'E1772022', u'E1772023', u'E1772024'],
            u'E1907': [u'E1907001', u'E1907002', u'E1907003', u'E1907007', u'E1907008', u'E1907009', u'E1907010',
                       u'E1907011', u'E1907012', u'E1907013', u'E1907014'],
            u'E2008': [u'E2008001', u'E2008002', u'E2008003', u'E2008004', u'E2008005', u'E2008006', u'E2008007',
                       u'E2008008', u'E2008009'],
            u'E2052': [u'E2052001', u'E2052002', u'E2052003', u'E2052004', u'E2052005', u'E2052006', u'E2052007',
                       u'E2052008', u'E2052009'],
